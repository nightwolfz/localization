    ...
    this.$get = [
        ...
        function($log, $injector, $rootScope, $q, $cookies) {
            var Storage, defaultInterpolator = $injector.get($interpolationFactory || '$translateDefaultInterpolation'), 
                pendingLoader = false, interpolatorHashMap = {}, langPromises = {}, fallbackIndex, startFallbackIteration,
                $translate = function(translationId, interpolateParams, interpolationId) {

                /*-------------- Ryan's little hack ------------------------*/
                translationId = translationId + '.values.' + $cookies.locale;
...
function($interpolate) {
    ...
    $translateInterpolator.interpolate = function (string, interpolateParams) {
        ...
        // Ryans interpolator (find {{key}} and translate them)
